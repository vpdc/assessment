...
describe('UserBirthdayGreetingSchedule', () => {
  ...
  it('should create schedule with the right arguments passed', () => {
    ...
    const schedule = new UserBirthdayGreetingSchedule(mockClient as any)
  ...
  it('should create a schedule', async () => {
    ...
    const schedule: Schedule = new UserBirthdayGreetingSchedule(client)
